...
const Pricing = () => {
  ...
  const handleDays = (event) => {
    ...
    setCost(event.target.value * hours * 4 * 300)
  }
  const handleHours = (event) => {
    setHours(Number(event.target.value))
    setCost(event.target.value * days * 4 * 300)
  }
        ...
        <div className="mt-16 px-10 xl:px-16">
          <div className="my-2 p-3 md:p-5">
            ...
            <div className="text-lg">
              <p>
                Sessions are 300 ETB per hour for KG-12 students for direct 1:1,
                tutor- student time.
              </p>
              <div>
                For KG-12:
                <br />
                300 ETB Birr Per Hour
              </div>
              {/* <div>
